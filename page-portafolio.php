...
<main class="pt-32 pb-24 bg-gray-950 min-h-screen font-['Inter',sans-serif]">
    <div class="max-w-[1400px] mx-auto px-6 lg:px-8">
        ...
        <div class="mt-32 text-center bg-gradient-to-b from-gray-900 to-gray-950 border border-gray-800 rounded-3xl p-12 lg:p-20 relative overflow-hidden">
            ...
            <h2 class="text-3xl md:text-5xl font-bold text-white mb-6 relative z-10">¿Listo para construir el tuyo?</h2>
            <p class="text-xl text-gray-400 mb-10 max-w-2xl mx-auto relative z-10">Trabajemos juntos para llevar tu proyecto al siguiente nivel de rendimiento y escalabilidad.</p>
