...
<main class="pt-32 bg-gray-950 min-h-screen">
    <div class="max-w-[1400px] mx-auto px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-20">
            <?php
            $hero_kicker = wp_ai_get_field_fallback('hero_kicker', 'Blog y Recursos');
            $hero_h1_normal = wp_ai_get_field_fallback('hero_h1_normal', 'Reflexiones sobre');
            $hero_h1_highlight = wp_ai_get_field_fallback('hero_h1_highlight', 'Ingeniería Web');
            $hero_description = wp_ai_get_field_fallback('hero_description', 'Artículos, tutoriales y análisis técnicos sobre rendimiento web, WordPress avanzado, y arquitecturas escalables.');
            ?>
        ...
        <div class="flex flex-wrap justify-center gap-3 mb-16">
            <?php $filter_all_label = wp_ai_get_field_fallback('blog_filter_all_label', 'Todos los Artículos'); ?>
        ...
        <?php if ($blog_query->max_num_pages > 1) : 
            $load_more_label = wp_ai_get_field_fallback('blog_load_more_label', 'Cargar más artículos');
            $loading_label = wp_ai_get_field_fallback('blog_loading_label', 'Cargando...');
        ?>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                loadMoreBtn.addEventListener('click', function() {
                    ...
                    const loadMoreText = btn.getAttribute('data-load-more-text') || 'Cargar más artículos';
        ...
        <?php
            wp_reset_postdata();
                ...
                $empty_title = wp_ai_get_field_fallback('blog_empty_title', 'No se encontraron artículos');
                $empty_desc = wp_ai_get_field_fallback('blog_empty_desc', 'Aún no hay contenido publicado en el blog.');
        ?>
    ...
    if(function_exists('wp_ai_render_component')) {
        $cta_h2 = wp_ai_get_field_fallback('cta_h2', '¿Listo para escalar tu web?');
        $cta_desc = wp_ai_get_field_fallback('cta_description', 'Deja que aplique todas estas técnicas de desarrollo en tu próximo proyecto para asegurar su éxito.');
        $cta_btn_text = wp_ai_get_field_fallback('cta_button_text', 'Hablemos de tu proyecto');
