    ...
    <div class="w-full max-w-[1400px] mx-auto px-6 lg:px-8 relative z-10 py-12 lg:py-0" data-hero-container>
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center lg:min-h-[calc(100vh-80px)]">
            ...
            <div class="lg:col-span-7 pt-8 pb-0 lg:py-0 text-center lg:text-left flex flex-col items-center lg:items-start">
                ...
                ?>
                <h1 class="relative w-full text-[clamp(2.75rem,12vw,4.8rem)] font-black tracking-tight mb-8 leading-[1.05] group" data-hero-headline data-glow-target>
                    <!-- Capa 1: Borde de texto iluminado con núcleo blanco -->
                    <span class="pointer-events-none absolute inset-0 block text-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100"
                          style="
                             ...
                             -webkit-mask-image: radial-gradient(200px circle at var(--mouse-x, 0px) var(--mouse-y, 0px), black 0%, transparent 70%);
                             mask-image: radial-gradient(200px circle at var(--mouse-x, 0px) var(--mouse-y, 0px), black 0%, transparent 70%);
                          " aria-hidden="true"><?php echo $headline_safe; ?></span>
                    
                    <!-- Capa 2: Texto original superpuesto -->
                    <span class="relative block text-gray-200"><?php echo $headline_safe; ?></span>
                </h1>
            ...
            <div class="hidden lg:flex lg:col-span-5 justify-center items-center" data-hero-terminal-container>
                <div class="relative w-full max-w-md group" data-hero-terminal data-glow-target>
                    <div class="relative rounded-xl border border-gray-800/80 bg-gray-900/60 backdrop-blur-xl shadow-2xl">
                        ...
                        <!-- Barra superior -->
                        <div class="relative z-10 flex items-center gap-2 px-4 py-3 border-b border-gray-800/50 bg-gray-900/80 rounded-t-xl">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const glowTargets = document.querySelectorAll('[data-glow-target]');
    if (!hero || glowTargets.length === 0) return;
